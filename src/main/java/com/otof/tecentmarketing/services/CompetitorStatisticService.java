...
@Service
@NoArgsConstructor
public class CompetitorStatisticService {
    ...
    public CompetitorEvaluation getCompetitorEvaluation(String location) throws URISyntaxException, InterruptedException {
        List<PoisEntity> poisEntityList = getCompetitorStaticResult(location);
        return competitorStatisticRules.analysisCompetitors(poisEntityList);
    }

    private List<PoisEntity> getCompetitorStaticResult(String location) throws URISyntaxException, InterruptedException {
        return getSurroundCompetitors(location, KiloEnum.THREEKILOMETER.radius);
    }

    private List<PoisEntity> getSurroundCompetitors(String location, String radius) throws URISyntaxException, InterruptedException {
